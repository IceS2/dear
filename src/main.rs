...
fn main() {
    ...
    let _initial_note = dear::create_note::execute(&mut repo, &dear::create_request("Initial Test", Some("Desc")));

    let _initial_note2 = dear::create_note::execute(&mut repo, &dear::create_request("Second Test", None));
